...
# Peak water
```{r, message=FALSE, warning=FALSE, fig.cap="Estimated development of glacier discharge."}
...
According to the model, peak water is already reached for the lesser emissions scenarios. We appear to be approximately at peak water for the higher emission scenarios (for which we are on track). 

# Glacier volume loss
```{r, message=FALSE, warning=FALSE, fig.cap="Estimated development of glacier volume."}
ggplot(fut_glacier_balance_basin |> 
         dplyr::select(-GCM) |> 
...
The reduction of the glacier water reservoirs in the Atbashy basin will amount to about 68%-76% of the current glacier volume.  
