...
@miles_health_2021 ran specific mass balance calculations over the glaciers larger than 2 km2 of High Mountain Asia. They provide the average glacier discharge between 2000 and 2016. We have derived an empirical relationship to derive glacier discharge based on glacier thinning rates. The data is available from the [data repository](<https://zenodo.org/record/5119153#.Yfjv6-rMKF4>) linked in the [online version of the paper](<https://www.nature.com/articles/s41467-021-23073-4>).
