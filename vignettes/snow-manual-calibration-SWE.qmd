...
#| warning: false
#| error: false
#| fig-cap: "Simulated SWE per HRU in the Atbashy model."
...
#| message: false
#| error: false
#| fig-cap: "Overall observed vs. simulated snow water equivalent in the Atbashy model."
...
#| message: false
#| error: false
#| fig-cap: "Observed vs. simulated snow water equivalent per month and per elevation band in the Atbashy model."
ggplot(compare_swe) +
  geom_abline(intercept = 0, slope = 1) + 
...
#| message: false
#| error: false
#| fig-cap: "Overall observed vs. simulated snow water equivalent in the Atbashy model after manual calibration using SWE extracted from HMASR."
swe_sim <- readResultCSV(
  paste0(data_path, 
...
#| message: false
#| error: false
#| fig-cap: "Observed vs. simulated snow water equivalent per month and per elevation band in the Atbashy model after manual calibration against SWE from HMASR."
ggplot(compare_swe) +
  geom_abline(intercept = 0, slope = 1) + 
  geom_point(aes(Obs, Sim, colour = `Elevation band`), size = 0.4) +
  scale_color_viridis_d() + 
...
#| message: false
#| error: false
#| fig-cap: "Average seasonal solid and liquid precipitation and contribution of the HBV model compartments and glacier melt to river discharge."
...
#| warning: false
#| error: false
#| fig-cap: "Flow duration curve of simulated monthly discharge at the planning location for a small hydropower plant. Black: Average flow duration curve over the period 1990-2021, grey: flow duration curve for the years 1990 - 2011." 
